...
public class ConnectMqtt5OutMessage extends ConnectMqtt311OutMessage {
  ...
  public ConnectMqtt5OutMessage(String clientId, int keepAlive) {
    this(
        StringUtils.EMPTY,
        StringUtils.EMPTY,
        clientId,
        ...
        MqttProperties.RECEIVE_MAX_PUBLISHES_IS_NOT_SET,
        MqttProperties.MAX_MESSAGE_SIZE_IS_NOT_SET,
  ...
  protected void writeProperties(MqttConnection connection, ByteBuffer buffer) {
    ...
    writeProperty(buffer, MqttMessageProperty.RECEIVE_MAXIMUM_PUBLISHES, receiveMax, MqttProperties.RECEIVE_MAX_PUBLISHES_IS_NOT_SET);
    writeProperty(
        buffer,
        MqttMessageProperty.TOPIC_ALIAS_MAXIMUM,
        topicAliasMaximum,
