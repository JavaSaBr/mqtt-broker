...
import static javasabr.mqtt.legacy.model.ActionResult.EMPTY;
import static javasabr.mqtt.legacy.model.ActionResult.FAILED;
import static javasabr.mqtt.legacy.model.reason.code.SubscribeAckReasonCode.SHARED_SUBSCRIPTIONS_NOT_SUPPORTED;
import static javasabr.mqtt.legacy.model.reason.code.SubscribeAckReasonCode.UNSPECIFIED_ERROR;
import static javasabr.mqtt.legacy.model.reason.code.SubscribeAckReasonCode.WILDCARD_SUBSCRIPTIONS_NOT_SUPPORTED;
import static javasabr.mqtt.legacy.model.reason.code.UnsubscribeAckReasonCode.NO_SUBSCRIPTION_EXISTED;
import static javasabr.mqtt.legacy.model.reason.code.UnsubscribeAckReasonCode.SUCCESS;
import static javasabr.mqtt.legacy.util.TopicUtils.hasWildcard;
import static javasabr.mqtt.legacy.util.TopicUtils.isInvalid;
