...
public enum PublishReceivedReasonCode {
    ...
    /**
     * The receiver does not accept the publish but either does not want to reveal the reason, or
     * it does not match one of the other values.
     */
    ...
    /**
     * The Packet Identifier is already in use. This might indicate a mismatch in the Session State
    ...
    public static @NotNull PublishReceivedReasonCode of(int index) {
