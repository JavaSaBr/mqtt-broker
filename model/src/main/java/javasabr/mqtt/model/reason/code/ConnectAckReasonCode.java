...
public enum ConnectAckReasonCode {
  ...
  public static ConnectAckReasonCode of(boolean mqtt5, int reasonCode) {
    return mqtt5 ? ofMqtt5(reasonCode) : ofMqtt311(reasonCode);
  }

  public static ConnectAckReasonCode ofMqtt311(int reasonCode) {
    switch (reasonCode) {
      case 0x00:
        return SUCCESS;
      case 0x01:
  ...
  public static ConnectAckReasonCode ofMqtt5(int reasonCode) {
  ...
  @Getter
  private final byte mqtt311;
  @Getter
  private final byte mqtt5;
}
