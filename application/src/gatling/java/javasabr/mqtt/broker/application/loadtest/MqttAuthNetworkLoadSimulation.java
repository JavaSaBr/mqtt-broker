...
public class MqttAuthNetworkLoadSimulation extends Simulation {
  ...
  private final FeederBuilder<Object> usersFeeder = listFeeder(clientIds)
    ...
    private final ScenarioBuilder scn = scenario("MQTT Authenticated Load Test")
        .exec(mqtt("ConnectAuth").connect())
        .feed(usersFeeder)
        .exec(mqtt("SubscribeAuth").subscribe("loadtest/#{clientId}/echo").qosAtLeastOnce())
